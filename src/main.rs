...
fn main() {
    unsafe {
        ...
        let index_buffer_memory_index = vulkan_example::find_memorytype_index(
        ...
        let vertex_input_buffer_memory_index = vulkan_example::find_memorytype_index(
        ...
        base.render_loop(|| {
            ...
            vulkan_example::record_submit_commandbuffer(
                &base.device,
